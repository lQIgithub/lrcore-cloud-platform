...
public class ValidateCodeFilter extends AbstractGatewayFilterFactory<Object> {
    private final static String[] VALIDATE_URL = new String[]{"/lrcore-auth/login", "/lrcore-auth/register"};
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            // 非登录/注册请求或验证码关闭，不处理
            if (!FunStrUtils.equalsAnyIgnoreCase(request.getURI().getPath(), VALIDATE_URL) || !captchaProperties.getEnabled()) {
